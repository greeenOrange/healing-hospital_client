  ...
  return (
    <div className="login-container lg:mt-28">
      <div className="login-section">
        <div className="login-box flex flex-col w-full lg:flex-row bg-slate-100 lg:p-7 md:p-5 border rounded-md">
          <div className="grid flex-grow card rounded-box lg:mt-16 lg:w-2/4">
          ...
          <form className="grid flex-grow card rounded-box lg:w-2/4 lg:pl-5 input-field" onSubmit={handleSubmit(onSubmit)}>
